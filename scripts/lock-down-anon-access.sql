...
-- Helpers (idempotent)
-- See scripts/secure-auth-helpers-and-is-admin-rpc.sql (do not default anon to admin)
...
BEGIN
  ...
  END IF;
  -- website_booking_intent RPCs: service_role only (see scripts/secure-website-booking-intent-rpc.sql)
END $$;
