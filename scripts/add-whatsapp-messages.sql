-- WhatsApp Cloud API message store (long retention — manual CRM delete).
...
--   - purge_ephemeral_data() does NOT delete whatsapp_messages (see whatsapp-inbox-long-retention.sql).
--
