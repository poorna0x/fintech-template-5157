            ...
            <div className="space-y-8">
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-muted-foreground">
                  <p>
                    At Hydrogen RO and Eleven RO (our related water-purifier service brands), we are committed to
                    protecting your privacy. This Privacy Policy describes how we handle personal data when you use
                    our websites (including hydrogenro.com and elevenro.com), book services, or interact with us
                    offline or by phone, SMS, or messaging apps.
                  </p>
                  <p>
              ...
              <Card>
                ...
                <CardContent className="space-y-4 text-muted-foreground">
                  <p>
                    Hydrogen RO and Eleven RO operate field water-purifier services with a place of business in
                    Bengaluru, Karnataka, India. This policy applies to personal data processed in connection with
                    those services and our public websites.
                  </p>
                  <p>
