      ...
      >
          ...
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <CardDescription className="mt-1">
                Master switch for CRM Cloud API only. When off, Cloud API send/inbox stops and the
                webhook does not store inbound. Phone wa.me buttons in Calling, documents, and
                payments still open WhatsApp on your phone.
              </CardDescription>
            </div>
            <Switch
        ...
        <CardContent>
          <Badge variant={settings.enabled ? 'default' : 'secondary'}>
            {settings.enabled ? 'Enabled' : 'Disabled — Cloud API off; wa.me still works'}
          </Badge>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <ToggleRow
            ...
            description="When a customer missed-calls an admin or technician phone, send a branded callback WhatsApp (we will get back to you + Call us). Uses last served brand, or Eleven RO if none. Includes last service date. Deduped for 6 hours. Requires Calling ON."
