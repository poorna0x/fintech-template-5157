                  ...
                  <div className="text-center space-y-3">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-3 justify-center items-center">
                      <Button 
                        ...
                        className="flex items-center gap-2 bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-gray-900 transition-all duration-300 hover:scale-105"
                      >
            ...
            <div className="flex justify-between">
              ...
              {currentStep < totalSteps ? (
                ...
                <Button
                  ...
                  className="flex items-center bg-gray-900 dark:bg-gray-100 hover:bg-gray-800 dark:hover:bg-gray-200 text-white dark:text-gray-900 transition-all duration-300 hover:scale-105 hover:shadow-lg disabled:hover:scale-100 disabled:hover:shadow-none disabled:opacity-50"
                >
