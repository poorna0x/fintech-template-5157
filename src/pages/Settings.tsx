...
const Settings = () => {
  ...
  useEffect(() => {
    if (showCallingPage || showWhatsAppInboxPage || showWhatsAppSettingsPage || showPdfAuthenticityPage || showRecurringServicePage) return;
  ...
  }, [ensureSettingsSectionLoaded, showCallingPage, showWhatsAppInboxPage, showWhatsAppSettingsPage, showPdfAuthenticityPage, showRecurringServicePage]);
