...
export const SETTINGS_SECTIONS = {
  ...
  'technician-locations': true,
  'todo-tasks': true,
  'letterhead-documents': true,
  'qr-image-generator': true,
  'payment-qr-codes': true,
  'quick-upi-qr': true,
  'upi-payment-accounts': true,
  'common-qr-codes': true,
  'product-qr-codes': true,
