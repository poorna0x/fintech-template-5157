...
const WA_TEMPLATE_ALIASES: Record<string, string> = {
  ...
  missed_call_book_cta: 'missed_call_callback_ero_cta',
  missed_call_book_ero_cta: 'missed_call_callback_ero_cta',
  missed_call_book_hro_cta: 'missed_call_callback_hro_cta',
