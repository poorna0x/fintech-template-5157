...
export const TIER1_CITY_HUBS: Tier1CityHub[] = [
  ...
  },
  {
    cityName: 'Hassan',
    citySlug: 'hassan',
    locationSlug: 'ro-service-hassan',
    subAreaSlugs: [
      'ro-service-bm-road-hassan',
      'ro-service-hassan-railway-station',
      'ro-service-vidyanagar-hassan',
      'ro-service-hemavathi-nagar',
      'ro-service-dairy-circle-hassan',
      'ro-service-arsikere',
      'ro-service-belur',
      'ro-service-sakleshpur',
      'ro-service-halebidu',
      'ro-service-channarayapatna',
    ],
  },
  {
    cityName: 'Udupi',
    citySlug: 'udupi',
    locationSlug: 'ro-service-udupi',
    subAreaSlugs: [
      'ro-service-udupi-temple',
      'ro-service-car-street-udupi',
      'ro-service-diana-circle',
      'ro-service-ambalpady',
      'ro-service-manipal',
      'ro-service-malpe-harbour',
      'ro-service-parkala',
      'ro-service-kundapura',
      'ro-service-karkala',
      'ro-service-brahmavar',
    ],
  },
];
