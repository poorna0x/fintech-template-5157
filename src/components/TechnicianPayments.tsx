          ...
          <Card>
            ...
            <CardContent>
              {(() => {
                ...
                const hasData = salaryBreakdowns.some(breakdown => {
                  ...
                  return periodPayments.length > 0 || breakdown.totalExpenses > 0 || breakdown.totalAdvances > 0 || breakdown.adjustedBaseSalary > 0 || totalEarnings !== 0;
                });
