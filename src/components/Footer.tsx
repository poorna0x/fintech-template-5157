        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-10">
          <div className="md:col-span-2 space-y-6 text-center md:text-left">
            ...
            <div className="flex items-center justify-center md:justify-start gap-4">
              <a
                href="#"
                aria-label="Follow Hydrogen RO on Twitter"
              ...
              >
                <span className="sr-only">Follow Hydrogen RO on Twitter</span>
              ...
              <a
                href="#"
                aria-label="Follow Hydrogen RO on LinkedIn"
                className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-foreground/75 hover:text-foreground transition-colors"
              >
                <span className="sr-only">Follow Hydrogen RO on LinkedIn</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <a
                href="#"
                aria-label="Follow Hydrogen RO on Facebook"
                className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-foreground/75 hover:text-foreground transition-colors"
              >
                <span className="sr-only">Follow Hydrogen RO on Facebook</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              ...
              <a
                href="#"
                aria-label="Follow Hydrogen RO on YouTube"
                className="h-10 w-10 rounded-full bg-muted flex items-center justify-center text-foreground/75 hover:text-foreground transition-colors"
              >
                <span className="sr-only">Follow Hydrogen RO on YouTube</span>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
