...
const AdminDashboard = () => {
  ...
  const [newJobFormData, setNewJobFormData] = useState({
    ...
    model: '',
    scheduled_date: '',
    scheduled_time_slot: 'MORNING' as 'MORNING' | 'AFTERNOON' | 'EVENING',
    description: '',
  ...
  const handleCreateJob = async () => {
    ...
    try {
      ...
      const jobData = {
        ...
        service_sub_type: newJobFormData.service_sub_type,
        brand: newJobFormData.brand,
        model: newJobFormData.model,
        scheduled_date: newJobFormData.scheduled_date,
        scheduled_time_slot: newJobFormData.scheduled_time_slot,
        estimated_duration: newJobFormData.estimated_duration,
        ...
        requirements: [],
        estimated_cost: newJobFormData.estimated_cost,
          ...
          {selectedCustomerForJob && isJobDialogReady && (
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <Label htmlFor="job_estimated_duration">Estimated Duration (minutes)</Label>
                  <Input
                    id="job_estimated_duration"
                    type="number"
                    value={newJobFormData.estimated_duration}
                    onChange={(e) => handleNewJobFormChange('estimated_duration', parseInt(e.target.value) || 120)}
                    placeholder="120"
                  />
                </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  type="number"
                  value={newJobFormData.estimated_cost}
                  onChange={(e) => handleNewJobFormChange('estimated_cost', parseInt(e.target.value) || 0)}
                  placeholder="0"
                />
              </div>
            </div>
