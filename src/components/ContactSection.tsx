...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-16 px-4 md:px-12 water-soft">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Call, WhatsApp or email — we reply fast.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 items-stretch">
          ...
          <Card className="cosmic-card h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              <div className="w-16 h-16 bg-sky-100 dark:bg-sky-500/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Phone className="w-8 h-8 text-sky-700 dark:text-sky-400" />
              </div>
          ...
          <Card className="cosmic-card h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              <div className="w-16 h-16 bg-sky-100 dark:bg-sky-500/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-sky-700 dark:text-sky-400" fill="currentColor" viewBox="0 0 24 24">
          ...
          <Card className="cosmic-card h-full">
            <CardContent className="p-8 text-center flex flex-col h-full">
              <div className="w-16 h-16 bg-sky-100 dark:bg-sky-500/15 rounded-full flex items-center justify-center mx-auto mb-4">
                <Mail className="w-8 h-8 text-sky-700 dark:text-sky-400" />
              </div>
