...
const FIELD_LABELS: Record<string, string> = {
  ...
  layoutMode: 'Page layout',
  date: 'Document date',
  subject: 'Subject',
  referenceNumber: 'Reference number',
  cc: 'CC',
  showRecipientBlock: 'Print recipient line',
  recipientLabel: 'Recipient label',
  showDocumentMeta: 'Print document number and date',
  showBrandTag: 'Brand pill',
  customerName: 'Recipient name',
  customerCompany: 'Recipient company',
  siteLocation: 'Site location',
  customerPhone: 'Customer phone',
  customerEmail: 'Customer email',
  blocks: 'Body content & layout',
  leftSignatory: 'Authorized signatory',
  rightSignatory: 'Second signatory',
  useBrandSealAsStamp: 'Brand seal',
  brandSealVariant: 'Seal style',
  hideLeftSignatory: 'Authorized signatory visibility',
  hideRightSignatory: 'Second signatory visibility',
