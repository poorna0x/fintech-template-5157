...
const SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { id: 'passkeys', label: 'Passkeys', description: 'Face ID or fingerprint sign-in on hydrogenro.com', keywords: 'security webauthn biometric fingerprint face id login passwordless', group: 'App & data', icon: Fingerprint, destination: { type: 'section', section: 'passkeys' }, adminOnly: true },
