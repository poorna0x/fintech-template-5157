...
const SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { id: 'jobs-map', label: 'Jobs map', description: 'Ongoing and follow-up jobs with nearby technicians on one map', keywords: 'live gps dispatch assign nearby ongoing followup follow-up pin technician location map', group: 'Customers & work', icon: MapPin, destination: { type: 'route', path: '/admin?tool=jobs-map' } },
