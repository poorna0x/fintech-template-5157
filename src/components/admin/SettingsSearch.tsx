...
const SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { id: 'service-hubs', label: 'Location hubs', description: 'Areas where website and WhatsApp booking is allowed', keywords: 'service area coverage radius map pincode book location hsr btm bellandur', group: 'Customers & work', icon: MapPin, destination: { type: 'panel', panel: 'service-hubs' }, adminOnly: true },
