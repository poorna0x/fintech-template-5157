...
const SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { id: 'storage', label: 'Usage & billing', description: 'Postgres, R2, Cloudinary, iLovePDF, and Google Maps', keywords: 'storage database space files media ilovepdf credits compress pdf google maps billing api usage places geocoding', group: 'App & data', icon: Database, destination: { type: 'panel', panel: 'db-storage' }, adminOnly: true },
