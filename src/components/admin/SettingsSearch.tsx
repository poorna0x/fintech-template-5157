...
const SEARCH_ITEMS: SettingsSearchItem[] = [
  ...
  { id: 'jobs-map', label: 'Jobs map', description: 'Ongoing jobs and nearby technicians on one map', keywords: 'live gps dispatch assign nearby ongoing pin technician location map', group: 'Customers & work', icon: MapPin, destination: { type: 'route', path: '/admin?tool=jobs-map' } },
