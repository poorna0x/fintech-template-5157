...
name: claude-seo
description: >
  Local + technical SEO guidance adapted from AgriciDaniel/claude-seo.
  Use for HydrogenRO/ElevenRO public-site SEO: NAP consistency, schema,
  robots/sitemaps, OG images, dual-brand head bootstrap, and local pack
  improvements. Trigger on "SEO", "local SEO", "schema", "sitemap",
  "NAP", "improve SEO", or "claude-seo".
user-invocable: true
license: MIT
metadata:
  author: AgriciDaniel
