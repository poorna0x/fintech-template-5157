...
const WA_TEMPLATE_ALIASES = {
  ...
  pending_payment: 'svc_balance_due_letter_ero_v9',
  pending_payment_hro: 'svc_balance_due_letter_ero_v9',
  pending_payment_ero: 'svc_balance_due_letter_ero_v9',
  payment_overdue: 'svc_payment_overdue_notice_ero_v3',
  payment_overdue_hro: 'svc_payment_overdue_notice_ero_v3',
  payment_overdue_ero: 'svc_payment_overdue_notice_ero_v3',
  ...
  missed_call_book_cta: 'missed_call_callback_hro_cta_v7',
  missed_call_book_ero_cta: 'missed_call_callback_ero_cta_v7',
  missed_call_book_hro_cta: 'missed_call_callback_hro_cta_v7',
  missed_call_callback_ero_cta_v3: 'missed_call_callback_ero_cta_v7',
  missed_call_callback_hro_cta_v3: 'missed_call_callback_hro_cta_v7',
  missed_call_callback_ero_cta_v5: 'missed_call_callback_ero_cta_v7',
  missed_call_callback_hro_cta_v5: 'missed_call_callback_hro_cta_v7',
  missed_call_callback_ero_cta_v6: 'missed_call_callback_ero_cta_v7',
  missed_call_callback_hro_cta_v6: 'missed_call_callback_hro_cta_v7',
