...
const JOB_COLS =
  'id,job_number,status,service_type,service_sub_type,scheduled_date,scheduled_time_slot,completed_at,end_time,payment_amount,actual_cost,payment_method,payment_status,booking_source,created_at,service_address,service_location,service_brand,before_photos,after_photos,images,brand,model,raw_water_tds';
