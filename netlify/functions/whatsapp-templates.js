...
const RECOMMENDED = [
  ...
  { name: 'reschedule_visit_ero_cta_v2', language: 'en', hint: 'Reschedule Eleven RO v2' },
  { name: 'reschedule_visit_hro_cta_v2', language: 'en', hint: 'Reschedule Hydrogen RO v2' },
  {
    name: 'existing_service_schedule_hro_cta_v3',
    language: 'en',
    hint: 'Existing customer schedule HRO v3',
  },
  {
    name: 'existing_service_schedule_ero_cta_v3',
    language: 'en',
    hint: 'Existing customer schedule ERO v3',
  },
  {
    name: 'unregistered_number_service_ero_cta_v2',
    language: 'en',
    hint: 'Unregistered number Eleven RO v2',
  },
  {
    name: 'unregistered_number_service_hro_cta_v2',
    language: 'en',
    hint: 'Unregistered number Hydrogen RO v2',
  },
  {
  ...
  },
  {
    ...
    language: 'en',
    hint: 'Missed call v6 UTILITY (from Water Filter Service + Call us + last service date)',
  },
  {
    name: 'missed_call_callback_ero_cta_v5',
    language: 'en',
    hint: 'Missed call Eleven RO v5 UTILITY (Call us + last service date)',
  },
  {
    name: 'missed_call_callback_hro_cta_v5',
    language: 'en',
    hint: 'Missed call Hydrogen RO v5 UTILITY (Call us + last service date)',
  },
  {
