...
exports.handler = async (event) => {
  ...
  try {
    ...
    return json(200, headers, {
      ...
      recommended: [
        {
          name: 'svc_balance_due_letter_hro_img_v3',
          language: 'en',
          hint: 'Balance due + QR IMAGE lean (HRO · no thank-you · Pay now)',
        },
        {
          name: 'svc_balance_due_letter_hro_v7',
          language: 'en',
          hint: 'Balance due letter lean + Pay now (HRO · no thank-you)',
        },
        {
          name: 'svc_balance_due_letter_ero_v7',
          language: 'en',
          hint: 'Balance due letter lean + Pay now (ERO · no thank-you)',
        },
        ...
        { name: 'svc_booking_confirmed_letter_hro_v4', language: 'en', hint: 'Booking confirmed letter Hydrogen RO v4' },
        { name: 'svc_booking_confirmed_letter_ero_v4', language: 'en', hint: 'Booking confirmed letter Eleven RO v4' },
        ...
        { name: 'existing_service_schedule_hro_cta_v2', language: 'en', hint: 'Existing customer schedule HRO v2' },
        { name: 'existing_service_schedule_ero_cta_v2', language: 'en', hint: 'Existing customer schedule ERO v2' },
