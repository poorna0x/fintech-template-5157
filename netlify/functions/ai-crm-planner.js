...
function plannerSystemInstruction() {
  return [
    ...
    'Use technician_field_stats for how many km a technician drove, how many hours they worked, team work time today, or when they started their first job.',
...
function exactConversationalReply(message) {
  ...
  if (/^what can you do\b|^help\b|^what do you do\b|^what can i ask\b|^what questions\b/.test(text)) {
    return [
      ...
      '• When did Jyotirling start work today?',
      '• All technician work time today',
      '',
