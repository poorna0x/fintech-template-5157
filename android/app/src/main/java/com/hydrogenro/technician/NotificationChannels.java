...
/**
 * The app's notification channel with the custom HydrogenRO alert sound
 * (res/raw/tech_alert.wav). Created natively, NOT from JS: the web app is
...
public final class NotificationChannels {
    ...
    public static void ensureJobAlerts(Context context) {
        ...
        Uri sound = Uri.parse(
            "android.resource://" + context.getPackageName() + "/raw/tech_alert");
        ...
        channel.setDescription("New job assignments and updates");
